...
;(function() {
  ...
  initialBox = { color: '#CD5C5C', x: 0, y: innerHeight - 80, width: 40, height: 80 } // 盒子的坐标宽高数据集合，根据这个数据来绘制盒子
  boxes = [{ ...initialBox }] // 页面绘制的盒子的数据
  jumperSpeed = { g: 2, vx: 6, vy: 40 } // 起跳移动速度数据
  initialJumper = { x: 0, y: innerHeight - 80 - 20, width: 20, height: 20, g: 2, vx: 2, vy: 20, color: '#f6aeab' } // 定义跳动的盒子的初始值，g：加速度，vx:x轴方向的速度，vy:y轴方向的速度
